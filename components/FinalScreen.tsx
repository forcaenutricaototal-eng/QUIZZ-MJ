    ...
    <div className="p-6 md:p-8 animate-fade-in w-full max-w-2xl mx-auto bg-white rounded-2xl shadow-xl text-gray-800">
      ...
      <div className="mt-8 text-center p-6 bg-emerald-50 rounded-xl border-2 border-emerald-200">
        ...
        <p className="text-gray-700 leading-relaxed mb-6 max-w-xl mx-auto">
          O próximo passo é simples. Para que nossa especialista apresente seu protocolo, explique os próximos passos e as condições especiais para começar, clique no botão abaixo.
        </p>
        ...
        <div className="mt-8">
          ...
          >
            <WhatsAppIconSVG />
            Liberar meu Protocolo no WhatsApp
          </a>
          <p className="text-gray-500 text-sm mt-4">Vagas limitadas para garantir o acompanhamento individual.</p>
        </div>
      </div>
    </div>
  );
